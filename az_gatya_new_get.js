...
var kome01 = [
    ['//azroyal.bakufu.org/imgpic/face_icon/ayanami.png','「よくわからないですけど……ちょっと嬉しい、です」','綾波'],
    ['//azroyal.bakufu.org/imgpic/face_icon/akagi.png','「ふふふ……赤城、いつでも準備万端ですわ」','赤城'],
    ['//azroyal.bakufu.org/imgpic/face_icon/akagi.png','「うふふふ…盛り上がってきたわ～」','赤城'],
    ['//azroyal.bakufu.org/imgpic/face_icon/akasi.png','「まいどありだにゃ～」','明石'],
    ['//azroyal.bakufu.org/imgpic/face_icon/gura-futuxextuperinn.png','「さぁ条件が全て揃った。では建造するとしよう......」','にくすべ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/San_Diego_1.png','「おめディエゴ！」','サンディエゴ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ayanami.png','「リアルは神ゲー…だったです？」','綾波'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Javelin.png','「ジャベリン、全力でイキま～す、です！」','ジャベリン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Javelin.png','「とってもラッキーです！」','ジャベリン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ruffy.png','「ラフィー…ガチャ…好き」','ラフィー'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ruffy.png','「この程度、あの時と比べて全然…」','ラフィー'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Prinz_Eugen.png','「指揮官～もう一回♪もう二回♪もっと回しちゃえ～」','オイゲン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ni-mi.png','「こうなったら仕方ありません、実力行使です！！」','ニーミ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Javelin.png','「ジャベリンは運がとってもいいんですよ！」','ジャベリン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ni-mi.png','「指揮官、ちゃんとコンプしてくださいね！」','ニーミ'],
  ];
 var kome02 = [
    ['//azroyal.bakufu.org/imgpic/face_icon/akagi.png','「うふふ…指揮官様、絶対に、絶対に、絶対に絶対に絶対に…この建造から逃げないでくださいね…」','赤城'],
    ['//azroyal.bakufu.org/imgpic/face_icon/akasi.png','「ん…？これは？課金が必要そうだにゃ…」','明石'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ayanami.png','「少しだけ悲しい…です」','綾波'],
    ['//azroyal.bakufu.org/imgpic/face_icon/gura-futuxextuperinn.png','「憎んでいる。すべてを。」','にくすべ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ruffy.png','「指揮官、がっかりした？（ツンツン」','ラフィー'],
    ['//azroyal.bakufu.org/imgpic/face_icon/San_Diego_1.png','「早くお金を出して！！このままじゃ「おりゅ？」になっちゃうよ！！」','サンディエゴ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/enterprise.png','「終わりだ！デデドン！(絶望)」','エンタープライズ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Saratoga.png','「うわぁ！大ピンチ！」','サラトガ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ayanami.png','「新キャラのためなら、「課金」してもいい……です」','綾波'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ayanami.png','「ガチャは嫌いではないけど好きじゃないです。」','綾波'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Javelin.png','「コンプしたいなら、回転数をもーっと増やさないとダメですよ？」','ジャベリン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ruffy.png','「指揮官、お金貸して、回す。」','ラフィー'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ruffy.png','「自己リミッター解除……」','ラフィー'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ni-mi.png','「…無理だよ。常識的に考えて」','ニーミ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ni-mi.png','「うぅ…だめ、まだ泣いちゃ…！」','ニーミ']
  ];
 var kome03 = [
    ['//azroyal.bakufu.org/imgpic/face_icon/Saratoga.png','「サラトガちゃん、あなた(のサイフ)がダイスキだよ～♪」','サラトガ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/unicorn.png','「ぐーぐるぷれい…？ユニコーン、お兄ちゃんが何言ってるかわかんない…」','ユニコーン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Saratoga.png','「ナントカナルゼッタイダイジョウブノープロブレム！」','サラトガ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/enterprise.png','「指揮官、教えてくれ。私はあと何回建造すればいい？」','エンタープライズ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/San_Diego_1.png','「よくわかんないけど、頑張ればきっとダイジョウブ！！」','サンディエゴ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Prinz_Eugen.png','「この程度で満足かしら？」','オイゲン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/akasi.png','「指揮官(のサイフ)ダイスキだにゃ！」','明石'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ni-mi.png','「回転数は大切ですよ。「出るまで回せば100％」と偉人の方が仰っていました……」','ニーミ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ayanami.png','「大丈夫です、指揮官…綾波を信じて――」','綾波'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Prinz_Eugen.png','「この程度じゃ足りないわ。もっと、もっとだ……！」','オイゲン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Javelin.png','「単発で当てちゃうよ！…えい！」','ジャベリン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/Javelin.png','「ナルホド　ナルホド　ソウイウ仕組ミナンデスネ」','ジャベリン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ruffy.png','「うん…二度寝しよう……」','ラフィー'],
    ['//azroyal.bakufu.org/imgpic/face_icon/unicorn.png','「くれじっとかーど？ないよ？そんなの…」','ユニコーン'],
    ['//azroyal.bakufu.org/imgpic/face_icon/ni-mi.png','「対策を考えないと……」','ニーミ'],
    ['//azroyal.bakufu.org/imgpic/face_icon/gura-futuxextuperinn.png','「神への祈りは果たして意味があるか？神が応えてくれるか？Nein(違う)、神は慈悲がないからこそ神になりえるのだ」','にくすべ'],
  ];
