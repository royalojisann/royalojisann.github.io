...
var teamslist = {
	...
	チュリッパ:{名前:'チュリッパ',フォルダ:'Kingdom_of_Tulipa'},
	リガ・デ・ペドレリーア:{名前:'リガ・デ・ペドレリーア',フォルダ:'Liga_de_Pedreria'},
	...
	'ニーアオートマータ':{名前:'ニーアオートマータ',フォルダ:'Collab_Nations'},
    ...
    var typelist = {
		...
		ミ駆:{名前:'ミ駆',正式名称:'ミサイル駆逐艦',グループ:'駆逐',ポジション:'前衛'},
        ...
        風帆S:{名前:'風帆S',正式名称:'風帆船',グループ:'潜水',ポジション:'潜水'},
	風帆M:{名前:'風帆M',正式名称:'風帆船',グループ:'特殊',ポジション:'主力'},
	風帆V:{名前:'風帆V',正式名称:'風帆船',グループ:'特殊',ポジション:'前衛'},
        //:{名前:'',正式名称:'',グループ:'',ポジション:''},
    }
